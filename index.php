  ...
  <body>
    <div class="wrapper-view">
      <div class="card">
        ...
        <div class="view mt-3">
          <span class="text-gray"> Staff Authentification </span>
          <form action="authentificationAdmin.php" method="post">
          <?php
                if(isset($_GET['erreur'])){
                    $err = $_GET['erreur'];
                    if($err==1){
                        echo "<div class='alert alert-danger my-3'>email ou mot de passe incorrect!!</div>";
                      }
                        if($err==2){
            ...
            <div class="form-group mt-3">
              ...
              <input class="form-control" type="text" placeholder="exemple@live.test" name="email"/>
            </div>
            <div class="form-group mt-3">
        ...
        <div class="footer-card">Are you a student? <a href="studentLog.php">Search your results</a></div>
      </div>
    </div>
    <script
