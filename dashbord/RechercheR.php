...
session_start();
	...
	$sql="select * from tabclasses a, tabetudiant b ,tabmoyenne c where a.id=b.classeId and b.id=c.idEtudiant and(b.nomEtudiant LIKE '%$rech%' or a.classeName LIKE '%$rech%' or c.moy LIKE '%$rech%')";
