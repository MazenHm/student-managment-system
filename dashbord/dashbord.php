        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"> Hi, welcome! <span class=" text-muted"><?php echo $_SESSION['e'] ?></span>
              </h3>
              <div class="d-flex">
                <button type="button" class="btn btn-sm bg-white btn-icon-text border">
                  <i class="mdi mdi-email btn-icon-prepend"></i> Email </button>
               
                <a href="addUser.php"><button type="button" class="btn btn-sm ml-3 btn-success"> Add User </button></a>
              </div>
            </div>
            <div class="row">
                      ...
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          ...
                          <?php 
                            ...
                            ?>
                            <p class="mb-0 color-card-head">Classes</p>
                            <h2 class="text-white"><?php echo $row ?>
                            </h2>
                          </div>
                          <i class="card-icon-indicator mdi mdi-book-open-variant bg-inverse-icon-warning"></i>
                        </div>
                        <h6 class="text-white">Nombre de classe</h6>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3">
                      ...
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          ...
                          <?php 
                                ...
                                $row=mysqli_num_rows($query_run);
                            ?>
                            <p class="mb-0 color-card-head">Etudiants</p>
                            <h2 class="text-white"><?php echo $row ?>
                            </h2>
                          </div>
                          <i class="card-icon-indicator mdi mdi-account-multiple bg-inverse-icon-danger"></i>
                        </div>
                        <h6 class="text-white">Nombre des etudiants</h6>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card bg-primary">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                          <?php 
                                $query1 = "select id from tabmoyenne order by id";
                                $query_run1=mysqli_query($connect,$query1);
                                $row1=mysqli_num_rows($query_run1);
                            ?>
                            <p class="mb-0 color-card-head">Résultats</p>
                            <h2 class="text-white"><?php echo $row1 ?>
                            </h2>
                          </div>
                          <i class="card-icon-indicator mdi mdi-checkbox-marked-outline bg-inverse-icon-primary"></i>
                        </div>
                        <h6 class="text-white">Nombre des résultat déclarée</h6>
                      </div>
                    </div>
                  </div>
