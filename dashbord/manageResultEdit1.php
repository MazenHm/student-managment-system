<?php
    ...
    $sql1="select * from  tabetudiant b ,tabmoyenne c where b.id=c.idEtudiant and c.id='$id'";
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basiccc">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="">Ajout Etudiant</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="">Manage Etudiant</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basicc">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="">Declare Résultat</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="">Manage Résultat</a>
                </li>
              </ul>
            </div>
          </li>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Declaré une resultat</h3>
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <p class="card-description">* champ obligatoire</p>

                    <form class="forms-sample" action="manageMoyenneEdit2.php" method="post">
                    <input value="<?php echo $row['id']?>" type="text" hidden name="id" class="form-control">
                        ...
                        <div class="form-group">
                                        <label for="inputAddress">* Etudiant</label>
                                        <input value="<?php echo $row['nomEtudiant']?>" readonly type="text" name="etudiant" class="form-control" >

                                        </div>
                      
                      <div class="form-group">
                        <label for="exampleInputName1">* Moyenne</label>
                        <input value="<?php echo $row['moy'] ?>" name="moyenne" type="text" class="form-control" id="exampleInputName1" placeholder="Moyenne" />
                      </div>
