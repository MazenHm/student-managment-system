...
session_start();
	...
	$sql="select * from tabclasses where classeName LIKE '%$rech%' or section LIKE '%$rech%' or niveau LIKE '%$rech%' or grade LIKE '%$rech%' ";
	                        ...
	                        while ($row=mysqli_fetch_assoc($res)){
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="manageClassesEdit1.php?id=<?php echo $row['id'] ?>"><i class="mdi mdi-square-edit-outline" style="color:#f6c23e;"></i></a>
                                                <a href="manageClassesSupp.php?id=<?php echo $row['id'] ?>"><i class="mdi mdi-trash-can-outline" style="color:#e74a3b"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                               $i++; }
