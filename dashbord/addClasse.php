      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="col-12 grid-margin stretch-card">
                ...
                if(isset($_GET['succes'])){
                    $err = $_GET['succes'];
                    if($err==1 || $err==2)
                        echo "<div class='alert alert-success my-3'>Classe added successfully</div>";
                }
                ?>
                ...
                if(isset($_GET['erreur'])){
                    $err = $_GET['erreur'];
                    if($err==1)
                        echo "<div class='alert alert-danger my-3'>class existe</div>";
                        if($err==2)
                ...
                ?>
                      ...
                      <select name="section" class="form-control form-control-lg" id="exampleFormControlSelect1">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="grade" class="form-control" id="exampleInputPassword4" placeholder="ex:1ère année" />
                      </div>
