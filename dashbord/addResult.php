            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <p class="card-description">* champ obligatoire</p>
                    ...
                    <form class="forms-sample" action="addResultX.php" method="post">

                    <?php
                if(isset($_GET['succes'])){
                    $err = $_GET['succes'];
                    if($err==1 || $err==2)
                        echo "<div class='alert alert-success my-3'>Result added successfully</div>";
                }
                ?>
                ...
                if(isset($_GET['erreur'])){
                    ...
                    if($err==1)
                        ...
                        if($err==2)
                          echo "<div class='alert alert-danger my-3'>resultat déja déclaré</div>";
                ...
                ?>
                      ...
                      <div class="form-group">
                        ...
                        <select name="etudiant" class="form-control" id="exampleSelectGender">
                        <option value="">Select Etudiant</option>
                        <?php 
		                                        while($row=mysqli_fetch_assoc($res1)){?>
			                                    <option value="<?php echo $row['id'] ?>"><?php echo $row['nomEtudiant']?> </option>
                      ...
                      <div class="form-group">
                        ...
                        <input name="moyenne" type="text" class="form-control" id="exampleInputName1" placeholder="Moyenne" />
                      </div>
