              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description">This User have The Same Rights Of You!</p>
                    <form class="forms-sample" action="addUserX.php" method="post" enctype="multipart/form-data">
                    <?php
                if(isset($_GET['succes'])){
                    $err = $_GET['succes'];
                    if($err==1 || $err==2)
                        echo "<div class='alert alert-success my-3'>user added successfully</div>";
                }
                ?>
                ...
                if(isset($_GET['erreur'])){
                    $err = $_GET['erreur'];
                    if($err==1)
                        echo "<div class='alert alert-danger my-3'>email déja existe</div>";
                        if($err==2)
                          echo "<div class='alert alert-danger my-3'>champ vide!!</div>";
                          if($err==3)
                          echo "<div class='alert alert-danger my-3'>passowrd different!!</div>";
                }
