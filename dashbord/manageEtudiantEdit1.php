<?php
    ...
    $sql2="select * from tabetudiant where id='$id'";
    $res2=mysqli_query($connect,$sql2);
    $row=mysqli_fetch_assoc($res2);

    $sql1="select * from tabclasses";
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Ajout Etudiant</h3>
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="manageEtudiantEdit2.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" value="<?php echo $row['id']?>" class="form-control" name="id" id="inputAddress" placeholder="Ex:2LGL">
  
                    <div class="form-group">
                        <label for="exampleInputName1">Name</label>
                        <input value="<?php echo $row['nomEtudiant']?>" name="nom" type="text" class="form-control" id="exampleInputName1" placeholder="Name" />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Email address</label>
                        <input value="<?php echo $row['email']?>" name="email" type="email" class="form-control" id="exampleInputEmail3" placeholder="Email" />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Password</label>
                        <input value="<?php echo $row['password']?>" name="password" type="text" class="form-control" id="exampleInputPassword4" placeholder="Password" />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Matricule</label>
                        <input value="<?php echo $row['matricule']?>" name="matricule" type="text" class="form-control" id="exampleInputEmail3" placeholder="Email" />
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                                        ...
                                        <select name="classe" style="width:100%;height: calc(2.25rem + 2px);border: 1px solid #ced4da;padding: 0.375rem 0.75rem;color: #495057;">
                                        <option value="">Select Class</option>

                                           <?php 
		                                        while($row=mysqli_fetch_assoc($res1)){?>
			                                    <option value="<?php echo $row['id'] ?>"><?php echo $row['classeName']?> </option>
