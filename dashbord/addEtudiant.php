            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <p class="card-description">* champ obligatoire</p>
                    ...
                    <form class="forms-sample" action="addEtudiantX.php" method="post" enctype="multipart/form-data">

                    <?php
                if(isset($_GET['succes'])){
                    $err = $_GET['succes'];
                    if($err==1 || $err==2)
                        echo "<div class='alert alert-success my-3'>Etudiant added successfully</div>";
                }
                ?>
                ...
                if(isset($_GET['erreur'])){
                    ...
                    if($err==1)
                        ...
                        if($err==2)
                          echo "<div class='alert alert-danger my-3'>matricule existe</div>";
                ...
                ?>
                      ...
                      <div class="form-group">
                        ...
                        <input name="matricule" type="text" class="form-control" id="exampleInputEmail3" placeholder="Email" />
                      </div>
                      <div class="form-group">
